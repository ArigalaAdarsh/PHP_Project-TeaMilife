...
<footer class="text-active" >
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom" style="z-index:900;">
    <!-- Left -->
       <span class="d-none d-sm-block">Get connected with uson social networks:</span>
       <span class="d-lg-none" >Get connected with us <br/>on social networks:</span>
